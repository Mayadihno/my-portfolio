...
export const portfolio: PortfolioProp[] = [
  ...
  },
  {
   ...
   {
    id: 13,
    name: "Caligata Publisher",
    image: image12,
    link: "https://caligatapub.com/",
    github: "https://github.com/Mayadihno",
    desc: "Publisher website for Caligata Publishing House. Built with React, Tailwind CSS, and Firebase.",
  },
];
